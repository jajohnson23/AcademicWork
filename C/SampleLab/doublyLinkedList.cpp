////////////////////////////////////////////////////////////////////////////
//	Program: LAB11
//	Author: origianlly provided by: Professor A Molin
//         some additions by: Joellyn A Johnson, jajohnson23
//  Date: Spring 2015
//
//	Description: Provides Template for a doubly linked list
//               copyList, the copt constructor and function to 
//               override the assignment operator added by student
//
////////////////////////////////////////////////////////////////////////////
...
/*******************************************************
 * Function: copyList
 * Description: copies the list passed as a parameter
 *              to the list passed implicitly
 *
 * param:
 *    otherList, the list to be copied
 * return: 
 *    none
 *******************************************************/
template<class Type>
...
//ENTER CODE HERE (20%)
  ...
  nodeType<Type> *current; //pointer to traverse the list
  nodeType<Type> *last; //node to follow just before current

  //if the list is not empty, make it empty
  if  (first != nullptr)
    destroy();

  //if the otherlist is empty, create an empty list for the copy
  if (otherList.first == nullptr)
  {
    first = nullptr;
    last = nullptr;
    count = 0;
  } else //else copy list contents
  {
    ...
    last = first;  //make last point to the cfirst
